...
public class LoadingView extends FrameLayout {
    ...
    public boolean btn_empty_enable = true;
    public boolean btn_error_enable = true;
    public boolean btn_nonet_enable = true;

    public LoadingView withBtnNoNetEnnable(boolean enable) {
        btn_nonet_enable = enable;
        return this;
    }

    public LoadingView withBtnErrorEnnable(boolean enable) {
        btn_error_enable = enable;
        return this;
    }


    public LoadingView withBtnEmptyEnnable(boolean enable) {
        btn_empty_enable = enable;
        return this;
    }
